...
public enum VehicleSpeedUSCustomary implements LocalUnit {
    ...
    public static final VehicleSpeedUSCustomary[] VALUES = VehicleSpeedUSCustomary.values();

    private String postFix = StringUtils.EMPTY;
    private double relativeSingleUnitValue;
    private double maxValue;

    private VehicleSpeedUSCustomary(String postFix, double singleUnitValue, double maxValue) {
