 ...
 *
 */
public enum FlowRateUSCustomary implements LocalUnit {

    CUBIC_FEET_SECOND("cubic ft/s", 1, Double.MAX_VALUE);

    public static final FlowRateUSCustomary[] VALUES = FlowRateUSCustomary.values();

    private String postFix = StringUtils.EMPTY;
    private double relativeSingleUnitValue;
    private double maxValue;

    private FlowRateUSCustomary(String postFix, double singleUnitValue, double maxValue) {
    ...
    public double toLocalValue(double amount) {
        return amount * VolumeUSCustomary.CUBIC_METRES_TO_CUBIC_FEET_MULTIPLIER_ACCURATE;
    }
