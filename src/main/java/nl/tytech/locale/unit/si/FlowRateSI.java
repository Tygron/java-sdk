 ...
 *
 */
public enum FlowRateSI implements LocalUnit {

    CUBIC_METRES_SECOND("m3/s", 1, 1000000000);

    public static final FlowRateSI[] VALUES = FlowRateSI.values();
    ...
    private FlowRateSI(String postFix, double singleUnitValue, double maxValue) {
