 ...
 *
 */
public enum VehicleEmissionSI implements LocalUnit {

    GRAM_KM("g/km", 1, Double.MAX_VALUE),//
    ;

    public static final VehicleEmissionSI[] VALUES = VehicleEmissionSI.values();
    ...
    private VehicleEmissionSI(String postFix, double singleUnitValue, double maxValue) {
