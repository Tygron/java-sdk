 ...
 *
 */
public enum VehicleSpeedSI implements LocalUnit {

    KMPH("km/h", 1, Double.MAX_VALUE),//
    ;

    public static final VehicleSpeedSI[] VALUES = VehicleSpeedSI.values();
    ...
    private VehicleSpeedSI(String postFix, double singleUnitValue, double maxValue) {
