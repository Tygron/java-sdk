...
public enum NoUnitDimension implements LocalUnit {
    ...
    NONE(StringUtils.EMPTY, StringUtils.EMPTY, 1, Double.MAX_VALUE),

    UNIT("unit", "units", 1, Double.MAX_VALUE),

    SPACES("space", "spaces", 1, Double.MAX_VALUE),

    BOOLEAN("bool", "bools", 1, Double.MAX_VALUE);

    public static final NoUnitDimension[] VALUES = NoUnitDimension.values();

    private String multiPostFix = StringUtils.EMPTY;
    private String postFix = StringUtils.EMPTY;
    private double relativeSingleUnitValue;
    private double maxValue;

    private NoUnitDimension(String postFix, String multiPostFix, double singleUnitValue, double maxValue) {
        this.postFix = postFix;
        this.multiPostFix = multiPostFix;
    ...
    public String getPostFix(boolean multi) {
        return multi ? multiPostFix : postFix;
    }
